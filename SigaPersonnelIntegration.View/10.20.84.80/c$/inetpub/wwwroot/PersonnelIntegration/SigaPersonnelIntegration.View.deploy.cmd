...
set _DeploySetParametersFile=%RootPath%SigaPersonnelIntegration.View.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%SigaPersonnelIntegration.View.zip" (
echo "%RootPath%SigaPersonnelIntegration.View.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%SigaPersonnelIntegration.View.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%SigaPersonnelIntegration.View.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%SigaPersonnelIntegration.View.deploy-readme.txt" (
...
start notepad "%RootPath%SigaPersonnelIntegration.View.deploy-readme.txt"
)
echo =========================================================
goto :eof
